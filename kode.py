...
class Parser:
    ...
    def expr(self):
        ...
        node = res.register(self.bin_op(
            self.comp_expr, ((TT_KEYWORD, 'DAN'), (TT_KEYWORD, 'OR'))))
    ...
    def atom(self):
        ...
        elif tok.matches(TT_KEYWORD, 'JK'):
...
global_symbol_table.set("KOSONG", Number.null)
